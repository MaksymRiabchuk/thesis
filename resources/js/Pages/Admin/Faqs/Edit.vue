...
const isEditing = computed(() => props.faq !== null);
      ...
      <form class="space-y-6" @submit.prevent="submit">
        <div class="space-y-1.5">
          ...
          <input
              ...
              type="text"
              placeholder="e.g. How do I return a rented item?"
          ...
          />
          <p v-if="form.errors.question" class="text-[13px] text-red-500">{{ form.errors.question }}</p>
        </div>
        ...
        <div class="space-y-1.5">
          ...
          <textarea
              ...
              class="w-full px-4 py-2.5 text-[15px] border border-[#e5e7eb] rounded-xl focus:outline-none focus:ring-1 focus:ring-[#3c9f52] focus:border-[#3c9f52] placeholder:text-[#9ca3af] text-[#111827] resize-y"
          />
          <p v-if="form.errors.answer" class="text-[13px] text-red-500">{{ form.errors.answer }}</p>
        </div>
        ...
        <div class="pt-4 flex justify-end gap-3 border-t border-gray-100">
          ...
          >
            {{ form.processing ? 'Saving...' : (isEditing ? 'Save Changes' : 'Create FAQ') }}
          </button>
        </div>
      </form>
    </div>
