...
<template>
  <div
      class="mx-4 sm:mx-auto mt-100 flex w-full max-w-md flex-col items-center rounded-lg border border-gray-200 p-4 shadow-lg"
  >
    ...
    <form class="w-full" @submit.prevent="onSubmit">
      ...
      <div class="flex justify-center">
        <Button class="w-full cursor-pointer text-lg" type="submit" :disabled="form.hasErrors"
                :loading="form.processing"> Login
        </Button>
      </div>
    </form>
  </div>
